...
import 'package:image_editor/component/emoticon.dart';
                  ...
                  ...stickers.map(
                      (stickers) => Center(
                        child: EmoticonSticker(
                          key: ObjectKey(stickers.id),
                          onTransform: () {
                            onTransform(stickers.id);
                          },
                          imgPath: stickers.imgPath,
                          isSelected: selectedId == stickers.id,
                        ),
                      ),
                  ),
                ],
